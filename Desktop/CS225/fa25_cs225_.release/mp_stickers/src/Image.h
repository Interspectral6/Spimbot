...
/**
 ...
 bool test_invert(){
  ...
  T cnm(2, 2);
  cnm.getPixel(0, 0).h = 77.7;
  cnm.getPixel(0, 0).s = 0.77;
  cnm.getPixel(0, 0).l = 0.77;
  cnm.getPixel(0, 0).a = 1.0;
  cnm.getPixel(1, 0).h = 66.6;
  cnm.getPixel(1, 0).s = 0.66;
  cnm.getPixel(1, 0).l = 0.66;
  cnm.getPixel(1, 0).a = 1.0;
  cnm.invert();
  if (cnm.getPixel(0, 0).h != 257.7 || cnm.getPixel(0, 0).s != 0.23 || cnm.getPixel(0, 0).l != 0.23 || cnm.getPixel(0, 0).a != 1.0) {
      return false;
  }
  if (cnm.getPixel(1, 0).h != 246.6 || cnm.getPixel(1, 0).s != 0.34 || cnm.getPixel(1, 0).l != 0.34 || cnm.getPixel(1, 0).a != 1.0) {
      return false;
  }
  return true;
 }